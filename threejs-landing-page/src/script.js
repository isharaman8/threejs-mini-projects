...
const texture = loader.load("/mt.jpg");
const alpha = loader.load("/updatedMap.png");
...
// gui.add(plane.rotation, "x").min(0).max(100).step(0.01);
// Mesh

// Lights

const pointLight = new THREE.PointLight(0x00c2eb, 3);
pointLight.position.x = 0.2;
pointLight.position.y = 10;
pointLight.position.z = 4.4;
scene.add(pointLight);

// DAT GUI FOR POINTLIGHT
...
const tick = () => {
	...
	plane.material.displacementScale = 0.25 + mouseY * 0.0009;
